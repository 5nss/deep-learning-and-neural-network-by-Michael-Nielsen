### implemented with l1 regu;arisation and cross entropy cost function
### the result of the someweights from the l1 are excatly recahed 0.0 rather than l2 become near 0 like 0.0001
   ...
   def SGD(self, training_data, epochs, mini_batch_size, eta,
    ...
    def total_cost(self, data, lmbda, convert=False):
        ...
        for x, y in data:
            ...
            cost += (lmbda / len(data)) * sum(np.sum(np.abs(w)) for w in self.weights) # '**' - to the power of.
        return cost
